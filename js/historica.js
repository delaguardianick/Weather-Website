...
function setData(weatherData){
	...
	$('#day-container').append(`
		<div class="historical-standard" data-day="`+dateObject.toLocaleString("en-US", {day: "numeric"})+`">
				...
				<p class="historical-info"><b>Feels Like:</b></p><br>
